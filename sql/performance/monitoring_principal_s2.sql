-- ============================================================
-- Monitoring principal - Scenario 2
-- A executer dans le schema BDDVenteS2
-- ============================================================
...
FROM Site2UserS2.lignecommandes2@site2_link;
...
EXPLAIN PLAN SET STATEMENT_ID = 'S2_CMD_CLIENT' FOR
...
SELECT * FROM TABLE(DBMS_XPLAN.DISPLAY(NULL, 'S2_CMD_CLIENT'));

PROMPT === Plan - chiffre affaires distribue ===
EXPLAIN PLAN SET STATEMENT_ID = 'S2_CA_DIST' FOR
...
SELECT * FROM TABLE(DBMS_XPLAN.DISPLAY(NULL, 'S2_CA_DIST'));
